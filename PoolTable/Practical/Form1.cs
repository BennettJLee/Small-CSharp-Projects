    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonGo_Click(object sender, EventArgs e)
        {
            ...
            while (i < NUM_BALLS)
            {
                ...
                ColorPoolBall newBall = new ColorPoolBall(random.Next(233), random.Next(117), random.Next(7) - 3, random.Next(7) - 3, Color.FromArgb(random.Next(256), random.Next(256), random.Next(256)));
